                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="title" type="text" class="form-control" id="title"
                                           placeholder="消息标题"
                                           value="<#if messageListDO??>${messageListDO.title!""}</#if>">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="beginTime" type="text" class="form-control" id="beginTime"
                                           ...
                                           value="<#if messageListDO??>${(messageListDO.beginTime)?replace("T"," ")!""}</#if>">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="endTime" type="text" class="form-control" id="endTime"
                                           ...
                                           value="<#if messageListDO??>${(messageListDO.endTime)?replace("T"," ")!""}</#if>">
                                </div>
                            </div>
                        </div>
                    </div>
