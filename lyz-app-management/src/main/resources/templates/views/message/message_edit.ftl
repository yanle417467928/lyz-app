<head>
    ...
    <script type="text/javascript" src="/javascript/message/message_edit.js"></script>
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab_1-1">
                <form id="activity_form">
                    <input type="hidden" name="id" value="<#if messageListDO??>${messageListDO.id?c}</#if>">
                    <input type="hidden" name="createTime"
                           value="<#if messageListDO??>${(messageListDO.createTime)?replace("T"," ")!""}</#if>">
                    <input type="hidden" name="status" value="<#if messageListDO??>${messageListDO.status!""}</#if>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="title" type="text" class="form-control" id="cusName"
                                           placeholder="消息标题" value="<#if messageListDO??>${messageListDO.title!""}</#if>">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="beginTime" type="text" class="form-control" id="beginTime"
                                           readonly placeholder="开始日期" value="<#if messageListDO??>${(messageListDO.beginTime)?replace("T"," ")!""}</#if>">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="endTime" type="text" class="form-control" id="endTime"
                                           readonly placeholder="结束日期" value="<#if messageListDO??>${(messageListDO.endTime)?replace("T"," ")!""}</#if>">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input name="target" value="ALL" type="checkbox"
                                           class="flat-red" <#if messageListDO??><#if messageListDO.scope?? && messageListDO.scope?contains('ALL')>checked</#if></#if>>全部
                                    <input name="target" value="ZDY" type="checkbox"
                                           class="flat-red" <#if messageListDO??><#if messageListDO.scope?? && messageListDO.scope?contains('ZDY')>checked</#if></#if>>自定义
                                    <input name="target" value="HY" type="checkbox"
                                           class="flat-red" <#if messageListDO??><#if messageListDO.scope?? && messageListDO.scope?contains('HY')>checked</#if></#if>>会员
                                    <input name="target" value="YG" type="checkbox"
                                           class="flat-red" <#if messageListDO??><#if messageListDO.scope?? && messageListDO.scope?contains('YG')>checked</#if></#if>>员工
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input name="identityType" value="MEMBER" type="radio" class="flat-red" <#if messageListDO??><#if messageListDO.identityType?? && messageListDO.identityType?contains('SELLER')>checked</#if></#if>>导购
                                    <input name="identityType" value="DELIVERY_CLERK" type="radio" class="flat-red" <#if messageListDO??><#if messageListDO.identityType?? && messageListDO.identityType?contains('DELIVERY_CLERK')>checked</#if></#if>>配送员
                                    <input name="identityType" value="DECORATE_MANAGER" type="radio" class="flat-red" <#if messageListDO??><#if messageListDO.identityType?? && messageListDO.identityType?contains('DECORATE_MANAGER')>checked</#if></#if>>装饰公司经理
                                    <input name="identityType" value="DECORATE_EMPLOYEE" type="radio" class="flat-red" <#if messageListDO??><#if messageListDO.identityType?? && messageListDO.identityType?contains('DECORATE_EMPLOYEE')>checked</#if></#if>>装饰公司员工
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="detailed"
                                              class="editor"><#if messageListDO??>${messageListDO.detailed!""}</#if></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
