<head>
    ...
    <script type="text/javascript" src="/javascript/deliveryFeeRule/deliveryFeeRule_page.js"></script>
</head>
<body>
            ...
            <div class="modal-body">
                <div class="user-block">
                    ...
                    <ul id="resourceDetail" class="list-group list-group-unbordered" style="margin-top:10px;">
                        ...
                        <li class="list-group-item">
                            <b>运费</b> <a class="pull-right" id="denomination"></a>
                        </li>
                        <li class="list-group-item">
                            <b>是否配置特殊商品</b> <a class="pull-right" id="remainingQuantity"></a>
                        </li>
                        <li class="list-group-item">
