            ...
            <div class="modal-body">
                <div class="user-block">
                    ...
                    <ul id="resourceDetail" class="list-group list-group-unbordered" style="margin-top:10px;">
                        ...
                        <li class="list-group-item">
                            <b>满减条件</b> <a class="pull-right" id="condition"></a>
                        </li>
                        <li class="list-group-item">
                            <b>面额</b> <a class="pull-right" id="denomination"></a>
                        </li>
                        <li class="list-group-item">
                            <b>有效期开始</b> <a class="pull-right" id="effectiveStartTime"></a>
                        </li>
                        <li class="list-group-item">
                            <b>有效期结束</b> <a class="pull-right" id="effectiveEndTime"></a>
                        </li>
                        <li class="list-group-item">
                            <b>使用说明</b> <a class="pull-right" id="descriptions"></a>
                        </li>
                        <li class="list-group-item">
                            <b>剩余数量</b> <a class="pull-right" id="remainingQuantity"></a>
                        </li>
                        <li class="list-group-item">
