                        ...
                        <div class="col-xs-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="loginName" type="text" class="form-control" id="loginName" placeholder="登录名称">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                    <input name="password" type="text" class="form-control" id="password" placeholder="用户密码">
                                </div>
                            </div>
                        </div>
                        <div class="row">
