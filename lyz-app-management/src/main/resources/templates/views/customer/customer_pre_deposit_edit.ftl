    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab_1-1">
                <form id="cus_pre_deposit_edit" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                    <input name="nickName" type="text" class="form-control" id="mobile"  readonly
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="mobile" type="text" class="form-control" id="mobile"  readonly
                                           placeholder="电话号码" value="${(customerPreDepositVO.balance)!'0.00'}">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-md-6">
