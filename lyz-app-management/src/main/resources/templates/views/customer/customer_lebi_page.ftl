...
<script>
    ...
    function initDateGird(keywords,cityId,storeId) {
        $grid.init($('#dataGrid'), $('#toolbar'), '/rest/customer/lebi/page/grid', 'get', false, function (params) {
            return {
    ...
    function showDetails(cusId){
        window.location.href = '/views/admin/customer/lebi/log/list/'+cusId;
    }
    function changePre(cusId){
        window.location.href = '/views/admin/customer/lebi/edit/'+cusId;
    }
</script>
</body>