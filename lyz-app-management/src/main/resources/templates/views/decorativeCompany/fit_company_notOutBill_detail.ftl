...
<section class="content">
    <div class="box">
        <div class="row" style="margin-top: 1%">
            <input name="billNo"  type="hidden" id="billNo" value="${maFitBillVO.billingNo!''}" readonly>
            <div class="col-xs-12">
...
<script>
    ...
    function inDataGrid1() {
        ...
        $grid.init($('#dataGrid1'), $('#toolbar1'), '/rest/fitBill/noPayOrderBill/grid/' + billNo, 'get', false, function (params) {
            return {
    ...
    function inDataGrid2() {
        ...
        var guideId = $('#guideId').val();
        $grid.init($('#dataGrid2'), $('#toolbar2'), '/rest/fitBill/payOrderBill/grid/' + billNo, 'get', false, function (params) {
            return {
                offset: params.offset,
                size: params.limit,
                keywords: params.search
