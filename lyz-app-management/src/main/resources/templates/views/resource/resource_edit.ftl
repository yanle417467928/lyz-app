<head>
    ...
    <script>
        $(function () {
            ...
            $('#resource_edit').bootstrapValidator({
                framework: 'bootstrap',
                feedbackIcons: {
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="description" type="text" class="form-control" id="description"
                                           placeholder="资源描述" value="${resource.description}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <select id="parentResource" name="parentResource" class="form-control select"
                                        data-live-search="true">
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input name="status" class="switch" id="status" type="checkbox" data-on-text="启用"
                                           data-off-text="停用" <#if resource.status?? && !resource.status>checked</#if>/>
                                </div>
                            </div>
                        </div>
                    </div>
