    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab_1-1">
                <form id="add_user" action="/views/admin/menu/update" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input name="title" type="text" class="form-control" id="title" value="${appAdminMenuDO.title}">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="form-group">
                                <label>图标样式</label>
                                <div class="input-group">
                                    <input name="iconStyle" type="text" class="form-control" id="iconStyle" value="${appAdminMenuDO.iconStyle}">
                                    <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            <div class="form-group">
                                <label>链接地址</label>
                                <div class="input-group">
                                    <input name="linkUri" type="text" class="form-control" id="linkUri" value="${appAdminMenuDO.linkUri}">
                                    <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-xs-12">
                            <div class="form-group">
                                <label>排序号</label>
                                <div class="input-group">
                                    <input name="sortId" type="text" class="form-control" id="sortId" value="${appAdminMenuDO.sortId}">
                                    <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <option value="PARENT" <#if type?? && type=="一级菜单">selected="selected"</#if>>一级菜单</option>
                                <option value="CHILD" <#if type?? && type=="二级菜单">selected="selected"</#if>>二级菜单</option>
                            </select>
                            </div>
                        </div>
                        <div class="col-md-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input name="referenceTable" type="text" class="form-control" id="referenceTable" value="${appAdminMenuDO.referenceTable}">
                                    <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            <div class="form-group">
                                <label>父节点ID</label>
                                <div class="input-group">
                                    <input name="parentID" type="text" class="form-control" id="parentID" value="${appAdminMenuDO.parent.id}">
                                    <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input name="parentTitle" type="text" class="form-control" id="parentTitle" value="${appAdminMenuDO.parent.title}">
                                    <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <input type="hidden" name="id" value="${appAdminMenuDO.id}">
                </form>
            </div>
                                ...
                                <#if menuVOList?? && menuVOList?size gt 0>
                                    <#list menuVOList as item>
                                        <option value="${(item.id!'0')?c}" data-icon="${item.iconStyle!'fa fa-circle-o'}"
                                                <#if menuDO?? && menuDO.id?? && menuDO.parentId?c == (item.id!'0')?c>selected</#if>>
                                        ${item.title!'加载失败...'}
                                        </option>
                                    </#list>
                                </#if>
