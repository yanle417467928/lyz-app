...
//                findByCondition();
    ...
    function initDateGird(keywords,startTime,endTime,storeId,storeType,cityId) {
        $grid.init($('#dataGrid'), $('#toolbar'), '/rest/reportDownload/billingItems/page/grid', 'get', false, function (params) {
            return {
    ...
    function openBillModal() {
        ...
        var url = "/rest/reportDownload/billingItems/download?keywords="+ keywords + "&storeId=" + storeId + "&startTime=" + startTime
