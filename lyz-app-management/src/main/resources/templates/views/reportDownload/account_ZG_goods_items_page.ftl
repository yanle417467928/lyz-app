...
//                findByCondition();
    ...
    function initDateGird(keywords,startTime,endTime,storeId,cityId) {
        $grid.init($('#dataGrid'), $('#toolbar'), '/rest/reportDownload/accountZGGoodsItems/page/grid', 'get', false, function (params) {
            return {
    ...
    function findByCondition() {
        ...
        var cityId = $('#cityCode').val();
        initDateGird(keywords,startTime,endTime,storeId,cityId);
    }
    ...
    function openBillModal() {
        ...
        var url = "/rest/reportDownload/accountZGGoodsItems/download?keywords="+ keywords + "&storeId=" + storeId + "&startTime=" + startTime
