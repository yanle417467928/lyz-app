...
<script>
    ...
    function initDateGird(startTime, endTime, storeId, storeType, cityId) {
        $grid.init($('#dataGrid'), $('#toolbar'), '/rest/reportDownload/employee/creditMoney/page/grid', 'get', false, function (params) {
            return {
    ...
    function openBillModal() {
        ...
        var url = "/rest/reportDownload/employee/creditMoney/download?&storeId=" + storeId + "&startTime=" + startTime
