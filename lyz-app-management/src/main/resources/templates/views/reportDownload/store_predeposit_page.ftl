...
<script>
    ...
    function initDateGird(startTime, endTime, storeId, storeType, cityId) {
        $grid.init($('#dataGrid'), $('#toolbar'), '/rest/reportDownload/store/predeposit/page/grid', 'get', false, function (params) {
            return {
    ...
    function openBillModal() {
        ...
        var url = "/rest/reportDownload/store/predeposit/download?&storeId=" + storeId + "&startTime=" + startTime
