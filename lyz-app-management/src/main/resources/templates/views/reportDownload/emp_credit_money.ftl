...
//                findByCondition();
    ...
    function initDateGird(keywords,startTime,endTime,storeId,storeType,cityId) {
        $grid.init($('#dataGrid'), $('#toolbar'), '/rest/reportDownload/empcredit/page/grid', 'get', false, function (params) {
            return {
    ...
    function openBillModal() {
        ...
        var url = "/rest/reportDownload/emp/credit?keywords="+ keywords + "&storeId=" + storeId + "&startTime=" + startTime
