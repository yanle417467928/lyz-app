...
CREATE TABLE IF NOT EXISTS MESSAGE_NOTIFICATION(
  ...
  MODIFIER_TYPE VARCHAR(100) NOT NULL COMMENT '上一次修改人类型',
  MODIFY_TIME DATETIME NOT NULL COMMENT '上一次修改时间',
  TITLE VARCHAR(25) NOT NULL COMMENT '消息标题',
  DETAILED VARCHAR(11) NOT NULL COMMENT '消息详情',
  PICTURE_URL VARCHAR(255) COMMENT '图片信息',
  IS_READ VARCHAR(10) NOT NULL COMMENT '是否已读',
...
/*功能反馈表 */
CREATE TABLE IF NOT EXISTS FUNCTIONAL_FEEDBACK(
  ID BIGINT(20) AUTO_INCREMENT PRIMARY KEY COMMENT '自增主键',
  CREATOR_ID BIGINT(20) NOT NULL COMMENT '数据创建者ID',
  CREATOR_TYPE VARCHAR(100) NOT NULL COMMENT '数据创建者类型',
  CREATE_TIME DATETIME NOT NULL COMMENT '数据创建时间',
