...
public interface MaReportDownloadService {
    ...
    PageInfo<SalesReportDO> findArrearsList(String companyCode, String storeType,String startTime, String endTime, Boolean isProductCoupon, List<Long> storeIds, Integer page, Integer size);

    List<SalesReportDO> downArrearsList(String companyCode, String storeType,String startTime, String endTime, Boolean isProductCoupon, List<Long> storeIds);
