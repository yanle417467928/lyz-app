package cn.com.leyizhuang.app.web.controller.sms;
...
public class SmsController {
    ...
    public ResultDTO<VerifyCodeResponse> getQrCode(String mobile) {
        ResultDTO<VerifyCodeResponse> resultDTO;
        logger.info("getQrCode CALLED,发送验证码，入参 mobile:{}", mobile);
        if (null == mobile || mobile.equalsIgnoreCase("") || mobile.trim().length() != 11) {
            resultDTO = new ResultDTO<>(CommonGlobal.COMMON_CODE_FAILURE, "手机号码不合法！", new VerifyCodeResponse(null));
        ...
        try {
            ...
            e.printStackTrace();
            resultDTO = new ResultDTO<>(CommonGlobal.COMMON_CODE_FAILURE, "验证码生成失败！", new VerifyCodeResponse(null));
    ...
    public ResultDTO<VerifyCodeResponse> getPuCode(String mobile) {
        ...
        try {
            ...
            e.printStackTrace();
            resultDTO = new ResultDTO<>(CommonGlobal.COMMON_CODE_FAILURE, "提货码生成失败！", new VerifyCodeResponse(null));
